...
public class CopyToolHelperMethodsTest {
	...
	public void tearDown() throws Exception {
		...
		deleteFile(workingDir.toString() + File.separator + "0.txt");
		deleteFile(workingDir.toString() + File.separator + "1.txt");
		deleteFile(workingDir.toString() + File.separator + "2.txt");
		deleteFile(workingDir.toString() + File.separator + "3.txt");
