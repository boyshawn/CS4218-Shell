...
public class EchoTool extends ATool implements IEchoTool {
	...
	public String echo(String toEcho) {
		String toEchoTemp = toEcho;
		
		if (toEchoTemp == null) {
			return "";
		}
		 
		int newLineIndex = toEchoTemp.indexOf(System.lineSeparator());
		if (newLineIndex == 0) {
			toEchoTemp = "";
		} else if (newLineIndex > 0) {
			toEchoTemp = toEchoTemp.substring(0, newLineIndex);
		}
		...
		toEchoTemp = toEchoTemp.trim();
		return toEchoTemp + System.lineSeparator();
	}
